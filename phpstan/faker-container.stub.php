...
/*
 * Derived from faker_mixin.php, which the faker package regenerates on every
 * package:discover — editing that file is pointless, and PHPStan validates a
 * stub even when the path is excluded from the analysis. The only change here
 * is the value types on the iterable @method signatures, which level 7 needs.
 *
 * Refresh this file if xefi/faker-php gains or renames extension methods.
 */

namespace Xefi\Faker\Container;

/**
 * @method list<string> wordsAsArray(int $words = 3)
 * @method string words(int $words = 3)
 * @method list<string> sentencesAsArray(int $sentences = 3)
 * @method string sentences(int $sentences = 3)
 * @method list<string> paragraphsAsArray(int $paragraphs = 3)
 ...
 * @method list<int> rgbColorAsArray()
 * @method string rgbColor()
 * @method string rgbCssColor()
 * @method list<int|float> rgbaColorAsArray()
 * @method string rgbaColor()
 * @method string rgbaCssColor()
 * @method list<int|float> hslColorAsArray()
 * @method string hslColor()
 * @method string hslCssColor()
 * @method list<int|float> hslaColorAsArray()
 ...
 * @method mixed randomElement(array<array-key, mixed> $elements)
 * @method mixed randomKey(array<array-key, mixed> $elements)
